...
times=[] #文章時間
#開始爬文（頁數）
for ranB in range(14):
    # 抓該板的文章
    latest_page = Board(Board_Name,2142-ranB)
    # 抓取資料
    for summary in latest_page:
        ...
        try:
            ...
            if len(article.title) != 0:
                ...
                times.append(int(article.datetime.strftime("%Y%m%d")))
        except:
            pass
...
KoreaDrama = pd.DataFrame(dic)
KoreaDrama.to_csv('KoreaDrama.csv',encoding = 'utf-8') #存檔
